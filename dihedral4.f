...
c +-----------------------------------+
c | setup vectors: 1=ik , 2=im , 3=jn |
c +-----------------------------------+
	      do ind=1,3
...
c +--------------------------------------------------------------------+
c | g3(Zi)*g3(Zj) * (ahat . bhat x chat)^2 * f(a) * f(b) * f(c) * f(d) |
c +--------------------------------------------------------------------+
	        ...
	        dz1= dot**4 * dz0 * (dgg(k1)*ff(k1) + gg*dff(k1))
	        dz2= gg * ff4 * 4.0d0/rr(k1) * dot**3
...
c +-----------------------------+
	      ...
	      fac= zdih * dot**4 * ff(1)*ff(2)*ff(3) * (bit1 + bit2)
