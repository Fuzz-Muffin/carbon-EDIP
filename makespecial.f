...
c +-----------------------------------------------+
c | Structure for graphite/diamond transformation |
c +-----------------------------------------------+
...
c +----------------------------------------------+
c | Structure for linear/graphite transformation |
c +----------------------------------------------+
 200  bx= -b*cosd(theta)
      by=  b*sind(theta)
...
c +-------------------------------+
c | Bensan out-of-plane bend: TMM |
c +-------------------------------+
 300  rcc=1.42
      rch=1.33
      rch2= rcc + 0.5*rch
...
c X-coords
      ...
      x(4,1)= -0.5*rcc - rch
      x(5,1)= -0.5*rcc - rch
      x(6,1)= -0.5*rcc + 0.5*rch
      x(7,1)= -0.5*rcc + 0.5*rch
...
c Y-coords
      ...
      x(4,2)=  root3on2*rcc
      x(5,2)= -root3on2*rcc
      x(6,2)=  root3on2*rcc + root3on2*rch
      x(7,2)= -root3on2*rcc - root3on2*rch
      x(8,2)= 0.0
      x(9,2)=   root3on2*rch
      x(10,2)= -root3on2*rch
...
c +-----------------------------------+
c | Bensan out-of-plane bend: benzene |
c +-----------------------------------+
 400  rcc=1.42
      rch=1.33
...
c Y-coords
      x(1,2)=  -root3on2*rcc
      x(2,2)=  -root3on2*rcc - root3on2*rch
      x(3,2)=  -root3on2*rcc
      x(4,2)=  -root3on2*rcc - root3on2*rch
      x(5,2)=  0.0
      x(6,2)=  0.0
      x(7,2)=   root3on2*rcc 
      x(8,2)=   root3on2*rcc + root3on2*rch
      x(9,2)=   root3on2*rcc
      x(10,2)=  root3on2*rcc + root3on2*rch
      x(11,2)=  0.0
      x(12,2)=  0.0
...
c +----------------------------------------+
c | Structure for linear chain with a bend |
c +----------------------------------------+
 500  do i=1,7
        x(i,1)= -1.33*(i-1)
        x(i,2)= 0.0
